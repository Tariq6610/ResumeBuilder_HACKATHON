    ...
    if (userdata && cvName && cvEmail && cvPhone && cvDP && cvAddress && cvDOB && cvSkills && cvEducation && cvCources && cvProjects) {
        ...
        data.Projects
            ...
            cvProjects.innerHTML +=
                "\n             <li class=\"activities\"><span>".concat(val.projectName, " -- </span>").concat(val.description, "</li>\n            ");
        });
    }
    else {
